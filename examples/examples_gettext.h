...
L"\n" 
L"/* [wxMaxima: comment start ]\n"  + _(
L"Until now we additionally have given nearly all equations names which means we can use them again whenever we want them. For example we can print them out again:\n" 
) + L"   [wxMaxima: comment end   ] */\n"  
L"\n" 
L"\n" 
L"/* [wxMaxima: input   start ] */\n" 
...
L"\n" 
L"/* [wxMaxima: comment start ]\n"  + _(
L"We can use them as input to solve:\n" 
) + L"   [wxMaxima: comment end   ] */\n"  
L"\n" 
L"\n" 
L"/* [wxMaxima: input   start ] */\n" 
