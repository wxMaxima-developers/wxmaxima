...
L"If the equation that defines the shape of a curve references the steepness of the curve (diff('f(x),x)), the steepness of the steepness of the curve (diff('f(x),x,2)) or any other derivation if the curve the result is a differential equation that describes the general shapes the curve can have without describing its actual height.\n" 
