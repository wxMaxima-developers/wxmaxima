...
void IntCell::Recalculate(AFontSize fontsize) {
    ...
    if (m_signHeight < 6)
        m_signHeight = 6;
    m_signWidth = Scale_Px(40.0) * 19.879 / 51.781;
