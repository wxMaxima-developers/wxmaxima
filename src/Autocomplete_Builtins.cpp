...
bool AutoComplete::LoadBuiltinSymbols() {
  ...
  m_wordList[command].Add("?derivsimp");    // OPTION
  m_wordList[command].Add("pathname_name"); // FUNCTION
  m_wordList[command].Add("fast_linsolve"); // FUNCTION
  m_wordList[tmplte].Add("fast_linsolve([<expr_1>, ..., <expr_m>], [<x_1>, "
                         "..., <x_n>])");                // OPTION
  ...
  m_wordList[tmplte].Add("extract_linear_equations([<p_1>, ..., <p_n>], "
                         "[<m_1>, ..., <m_n>])");                   // OPTION
  ...
  m_wordList[tmplte].Add("alias(<new_name_1>, <old_name_1>, ..., <new_name_n>, "
                         "<old_name_n>)");                           // OPTION
  ...
  m_wordList[tmplte].Add("set_draw_defaults(<graphic option>, ..., <graphic "
                         "object>, ...)");           // OPTION
  ...
  m_wordList[tmplte].Add("ifs(<[><r1>, ..., <rm><]>, <[><A1>, ..., <Am><]>, "
                         "<[[><x1>, <y1><]>, ..., <[><xm>, <ym><]]>, <[><x0>, "
                         "<y0><]>, <n>, ..., options, ...);"); // OPTION
  ...
  m_wordList[tmplte].Add("poly_ideal_polysaturation(<polylist>, "
                         "<polylistlist>, <varlist>)"); // OPTION
  m_wordList[command].Add("poly_saturation_extension"); // FUNCTION
  m_wordList[tmplte].Add("poly_saturation_extension(<poly>, <polylist>, "
                         "<varlist1>, <varlist2>)");        // OPTION
  m_wordList[command].Add("poly_polysaturation_extension"); // FUNCTION
  m_wordList[tmplte].Add("poly_polysaturation_extension(<poly>, <polylist>, "
                         "<varlist1>, <varlist2>)");               // OPTION
  ...
  m_wordList[tmplte].Add("output_format_for_help");                // OPTION
  m_wordList[tmplte].Add("browser");                               // OPTION
  m_wordList[tmplte].Add("browser_options");                       // OPTION
  m_wordList[tmplte].Add("url_base");                              // OPTION
  ...
  m_wordList[tmplte].Add("quad_qag(<f(x)>, <x>, <a>, <b>, <key>, [<epsrel>, "
                         "<epsabs>, <limit>])"); // OPTION
  m_wordList[tmplte].Add("quad_qag(<f>, <x>, <a>, <b>, <key>, [<epsrel>, "
                         "<epsabs>, <limit>])"); // OPTION
  ...
  m_wordList[tmplte].Add("quad_qawc(<f(x)>, <x>, <c>, <a>, <b>, [<epsrel>, "
                         "<epsabs>, <limit>])"); // OPTION
  m_wordList[tmplte].Add("quad_qawc(<f>, <x>, <c>, <a>, <b>, [<epsrel>, "
                         "<epsabs>, <limit>])"); // OPTION
  m_wordList[command].Add("quad_qawf");          // FUNCTION
  m_wordList[tmplte].Add("quad_qawf(<f(x)>, <x>, <a>, <omega>, <trig>, "
                         "[<epsabs>, <limit>, <maxp1>, <limlst>])"); // OPTION
  m_wordList[tmplte].Add("quad_qawf(<f>, <x>, <a>, <omega>, <trig>, [<epsabs>, "
  ...
  m_wordList[tmplte].Add("quad_qaws(<f>, <x>, <a>, <b>, <alpha>, <beta>, "
                         "<wfun>, [<epsrel>, <epsabs>, <limit>])"); // OPTION
  ...
  m_wordList[tmplte].Add("decsym(<tensor>, <m>, <n>, [<cov_1>, <cov_2>, ...], "
  ...
  m_wordList[tmplte].Add("locate_matrix_entry(<M>, <r_1>, <c_1>, <r_2>, <c_2>, "
                         "<f>, <rel>)");              // OPTION
  ...
  m_wordList[tmplte].Add("lsquares_estimates(<D>, <x>, <e>, <a>, initial = "
                         "<L>, tol = <t>)");                      // OPTION
  ...
  m_wordList[tmplte].Add("lsquares_estimates_approximate(<MSE>, <a>, initial = "
                         "<L>, tol = <t>)");                        // OPTION
  ...
  m_wordList[tmplte].Add("minpack_lsquares(<flist>, <varlist>, <guess> [, "
                         "<tolerance>, <jacobian>])"); // OPTION
  m_wordList[command].Add("minpack_solve");            // FUNCTION
  m_wordList[tmplte].Add("minpack_solve(<flist>, <varlist>, <guess> [, "
                         "<tolerance>, <jacobian>])");               // OPTION
  ...
  m_wordList[tmplte].Add("deftaylor(<f_1>(<x_1>), <expr_1>, <...>, "
  ...
  m_wordList[tmplte].Add("taylor(<expr>, [<x_1>, <x_2>, <...>], [<a_1>, <a_2>, "
                         "<...>], [<n_1>, <n_2>, <...>])"); // OPTION
  m_wordList[tmplte].Add("taylor(<expr>, [<x_1>, <a_1>, <n_1>], [<x_2>, <a_2>, "
                         "<n_2>], <...>)");                         // OPTION
  ...
  m_wordList[tmplte].Add("direct([<p_1>, <...>, <p_n>], <y>, <f>, [<lvar_1>, "
                         "<...>, <lvar_n>])");    // OPTION
  ...
  m_wordList[tmplte].Add("pui_direct(<orbite>, [<lvar_1>, <...>, <lvar_n>], "
                         "[<d_1>, <d_2>, <...>, <d_n>])"); // OPTION
