...
{
  GroupCell::RecalculateWidths();
  GroupCell::RecalculateHeight();
}

void GroupCell::RecalculateWidths()
{
  ...
  if (NeedsRecalculation())
  {
    ...
    if(m_inputLabel != NULL)
    {
      m_inputLabel->RecalculateWidthsList();
...
void GroupCell::RecalculateHeightInput()
{
      ...
      (m_groupType != GC_TYPE_CODE))
  {
    if(m_inputLabel)
    {
      m_inputLabel->RecalculateHeightList();
...
void GroupCell::RecalculateHeight()
{
  if(NeedsRecalculation())
  {
