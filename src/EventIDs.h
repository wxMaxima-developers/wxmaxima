...
*/
  ...
  */
  ...
  static const wxWindowIDRef menu_pane_aiMonitor; //!< Both the "toggle the AI connection monitor pane" command and the pane itself
  ...
  */
  ...
  static const wxWindowIDRef menu_kill_dependencies;
  static const wxWindowIDRef menu_kill_values;
  static const wxWindowIDRef menu_kill_functions;
  static const wxWindowIDRef menu_kill_arrays;
  static const wxWindowIDRef menu_kill_myoptions;
  static const wxWindowIDRef menu_kill_rules;
  static const wxWindowIDRef menu_kill_aliases;
  static const wxWindowIDRef menu_kill_structures;
  static const wxWindowIDRef menu_kill_labels;
  static const wxWindowIDRef menu_kill_gradefs;
  static const wxWindowIDRef menu_kill_props;
  static const wxWindowIDRef menu_kill_macros;
  static const wxWindowIDRef menu_kill_let_rule_packages;
  static const wxWindowIDRef menu_garbage_collect;
  ...
  static const wxWindowIDRef menu_regex_isRegex;
