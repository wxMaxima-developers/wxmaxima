...
const wxWindowIDRef EventIDs::menu_submatrix_rows(wxWindow::NewControlId());
const wxWindowIDRef EventIDs::menu_submatrix_columns(wxWindow::NewControlId());
...
const wxWindowIDRef EventIDs::popid_copy_html(wxWindow::NewControlId());
