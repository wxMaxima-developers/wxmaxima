...
wxMaxima::wxMaxima(wxWindow *parent, int id,
  ...
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::popid_insert_subsection);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::popid_insert_subsubsection);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::popid_insert_heading5);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::popid_insert_heading6);
  ...
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_add_comment);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_add_section);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_add_subsection);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_add_subsubsection);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_add_heading5);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_add_heading6);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_add_title);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_add_pagebreak);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_fold_all_cells);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_unfold_all_cells);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::popid_add_comment);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::popid_add_watch);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::popid_add_watch_label);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_insert_previous_input);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_insert_previous_output);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_autocomplete);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_autocomplete_templates);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_insert_input);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::popid_insert_input);
  ...
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_insert_image);
  ...
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::popid_auto_answer);
  Bind(wxEVT_MENU, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::popid_never_autoanswer);
  ...
  Bind(wxEVT_BUTTON, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_format_title);
  Bind(wxEVT_BUTTON, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_format_text);
  Bind(wxEVT_BUTTON, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_format_heading6);
  Bind(wxEVT_BUTTON, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_format_heading5);
  Bind(wxEVT_BUTTON, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_format_subsubsection);
  Bind(wxEVT_BUTTON, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_format_subsection);
  Bind(wxEVT_BUTTON, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_format_section);
  Bind(wxEVT_BUTTON, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_format_pagebreak);
  Bind(wxEVT_BUTTON, &MaximaCommandMenus::OnInsertMenu, &m_menuCommands, EventIDs::menu_format_image);
