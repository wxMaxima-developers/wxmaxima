...
// Handles events generated by Inspector.cpp
// Inspector.cpp provides the right command with
// GetMaximaCommand();
void wxMaxima::OnInspectorEvent(wxCommandEvent& ev)
{
...
BEGIN_EVENT_TABLE(wxMaxima, wxFrame)
  ...
  EVT_UPDATE_UI(menu_pane_inspector, wxMaxima::UpdateMenus)
  ...
  EVT_BUTTON(inspector_update_id, wxMaxima::OnInspectorEvent)
